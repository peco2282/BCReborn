...
public class BoardRobotShovelman extends BoardRobotGenericBreakBlock<BoardRobotShovelman> {

  public BoardRobotShovelman(RobotEntityBase iRobot) {
    super(RoboticsAIType.SHOVELMAN, iRobot);
  }

  @Override
  public RedstoneBoardRobotNBT getNBTHandler() {
    return RoboticsRedstoneRobots.ROBOT_SHOVELMAN.get();
  }
