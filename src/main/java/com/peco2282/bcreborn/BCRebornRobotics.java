...
@Mod(BCRebornRobotics.MODID)
public class BCRebornRobotics implements BCReborn {
  // Define mod id in a common place for everything to reference
  public static final String MODID = "bcrebornrobotics";
  ...
  public BCRebornRobotics(FMLJavaModLoadingContext context) {
  ...
  public static ResourceLocation location(String path) {
    return BCReborn.getLocation(Type.ROBOTICS, path);
  }
