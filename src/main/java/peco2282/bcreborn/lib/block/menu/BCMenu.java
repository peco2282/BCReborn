...
/**
 * Represents the base class for custom menu implementations. This class is used as a foundation for
 * creating custom menus in the game. It manages the player's inventory slots and facilitates
 * inventory interactions.
 *
 * <p>To use this class, extend it and provide a specific {@link MenuType}. Use {@link
 * #addFullPlayerInventory(int, int)} to add standard player inventory slots.
 *
 * <p><b>Example Usage:</b>
 *
 * <pre>
...
public abstract class BCMenu extends AbstractContainerMenu {
  ...
  /**
   * Adds the full set of player inventory slots to this menu. This includes both the main inventory
   * (3 rows of 9 slots) and the hotbar (1 row of 9 slots).
   *
