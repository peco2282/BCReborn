...
public class BCCoreFluids {
  public static final RegistryObject<Oil.Source> OIL_SOURCE =
      register("oil_source", Oil.Source::new);
  public static final RegistryObject<Oil.Flowing> OIL_FLOWING =
      register("oil_flowing", Oil.Flowing::new);
  public static final RegistryObject<Fuel.Source> FUEL_SOURCE =
      register("fuel_source", Fuel.Source::new);
  public static final RegistryObject<Fuel.Flowing> FUEL_FLOWING =
      register("fuel_flowing", Fuel.Flowing::new);

  public static final RegistryObject<FluidType> OIL =
      BCRegistry.registerFluidType(
          "oil",
          () ->
              new FluidType(
  ...
  public static final RegistryObject<FluidType> FUEL =
      BCRegistry.registerFluidType(
          "fuel",
          () ->
              new FluidType(
