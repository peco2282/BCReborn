...
/**
 * The DataGenerator class is responsible for handling the Minecraft data generation process. It
 * listens for the {@link GatherDataEvent} and registers various data providers for blocks, items,
 * fluids, advancements, languages, recipes, models, and registry entries.
 *
 * @author peco2282
 */
public class DataGenerator {
   ...
   * data such as block tags, item tags, fluid tags, advancements, item models, recipes, language
   * files, and registry entries.
   *
   * @param event the data gathering event that provides the necessary information and tools for
  ...
  public static void onGatherData(GatherDataEvent event) {
    ...
    generator.addProvider(
        true, new BCItemTagsProvider(output, provider, blockTags.contentsGetter()));
