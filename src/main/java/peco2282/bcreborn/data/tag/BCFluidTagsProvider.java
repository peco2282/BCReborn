...
/**
 * This class provides fluid tags for the BC Reborn mod.
 * It extends {@link FluidTagsProvider} to define custom tags for fluids.
 *
 * <p>Use this provider for generating and managing fluid tags during the datapack loading process.</p>
 *
 * @author peco2282
 */
public class BCFluidTagsProvider extends FluidTagsProvider {
   ...
   *
   * <p>This method overrides {@link FluidTagsProvider#addTags}
   * to define custom tags for fluids.</p>
   *
