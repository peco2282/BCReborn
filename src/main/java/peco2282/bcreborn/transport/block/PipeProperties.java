...
/**
 * A utility class that defines various {@link PropertyBuilder} instances for pipe properties.
 * These properties are grouped based on material types (e.g., Wooden, Stone, etc.) and categorized by their use
 * (Item transportation, Fluid transportation, and Energy transportation).
 */
